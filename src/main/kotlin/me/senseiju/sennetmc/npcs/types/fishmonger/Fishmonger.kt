...
class Fishmonger(plugin: SennetMC) : BaseNpc {
    ...
    override fun spawnNpc(location: Location) {
        ...
        npc.getOrAddTrait(Equipment::class.java)
            .set(Equipment.EquipmentSlot.OFF_HAND, ItemStack(Material.TROPICAL_FISH_BUCKET))
